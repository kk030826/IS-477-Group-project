...
<!-- TODO (Colin): Draft this section -->

## Challenges (~500 words)

<!-- TODO (Colin): Draft this section — can adapt from StatusReport.md sections 4.1–4.3 -->
...
<!-- TODO (Colin): Add formatted citations. Suggested format: -->
<!-- 
